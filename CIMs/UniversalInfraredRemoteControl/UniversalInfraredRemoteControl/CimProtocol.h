...
#define UIRC_CIM_FEATURE_UNIQUENUMBER     0x00
#define UIRC_CIM_FEATURE_SET_IR_MODE 	 0x08
#define UIRC_CIM_FEATURE_GET_IR_STATE 	 0x09
#define UIRC_CIM_FEATURE_SET_IR_CODE 	 0x0A		// Get IR Code from ARE
#define UIRC_CIM_FEATURE_GET_IR_CODE	 0x0B		// Send IR Code to ARE
...
void generate_StateFrame(void);
void generate_RecordFrame(void);
void generate_Timerdatabuffer(void);
