...
//Ausgabe des Directorys
unsigned int ClustervarRoot;
unsigned int ClustervarFolder;
unsigned int ClustervarFolders[NUMBER_OF_DEVICES];
unsigned int ClustervarFile;
unsigned int ClustervarFiles[NUMBER_OF_FUNCTIONS];
unsigned int ClustervarINFO;
unsigned int ClustervarCONFIG;
