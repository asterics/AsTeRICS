...
const char TEENSY_CIM_FEATURELIST[]=
{
   ...
   0x03,0x00,  // Sendet Events, 0 wenn aktueller Wert zuerst höher als der Schwellwert war und dann darunter fällt,
   			   // 1 wenn aktueller Wert niederiger als Schwellwert war und dann darüber steigt
