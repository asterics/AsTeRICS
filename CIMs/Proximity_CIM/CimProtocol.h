...
#define TEENSY_CIM_FEATURE_SEND_DATA		 0x01
#define TEENSY_CIM_FEATURE_SET_THRESHOLD	 0x02
#define TEENSY_CIM_FEATURE_SEND_EVENT		 0x03
#define TEENSY_CIM_FEATURE_SET_ADCPERIOD 	 0x04
#define TEENSY_CIM_FEATURE_ADCREPORT 	     0x05
#define TEENSY_CIM_FEATURE_MODE_SELECTION	 0x06
...
extern volatile uint16_t selection;
//extern volatile uint16_t send;
...
void generate_ADCFrame(uint16_t value);
