...
#define INBUF_SIZE 180      // 180 bytes for ringbuffers to store HID requests
#define INBUF_WARNING 15

#define OUTBUF_SIZE 90      // 90 bytes for ringbuffer to store CIM replies
