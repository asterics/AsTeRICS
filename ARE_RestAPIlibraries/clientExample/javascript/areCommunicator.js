...
function getRuntimeComponentPropertyKeys(
  successCallback,
  errorCallback,
  componentId
) {
...
function getRuntimeComponentProperty(
  successCallback,
  errorCallback,
  componentId,
  propertyKey
...
function getRuntimeComponentPropertyDynamic(
  successCallback,
  errorCallback,
  componentId,
  propertyKey
...
function setRuntimeComponentProperties(
  successCallback,
  errorCallback,
  propertyMap
) {
...
function setRuntimeComponentProperty(
  successCallback,
  errorCallback,
  componentId,
  propertyKey,
...
function getComponentEventChannelsIds(
  successCallback,
  errorCallback,
  componentId
) {
...
function getComponentDataChannelsIds(
  successCallback,
  errorCallback,
  componentId
) {
...
function getComponentOutputPortIds(
  successCallback,
  errorCallback,
  componentId
) {
...
function storeWebappData(
  ...
  $.ajax({
    ...
    url:
      _baseURI +
      "storage/webapps/" +
      encodeParam(webappId) +
      "/" +
      encodeParam(filepath),
    contentType: "text/plain",
    data: data,
    datatype: "text",
    crossDomain: true,
...
function subscribe(successCallback, errorCallback, eventType, channelId) {
  ...
  switch (eventType) {
    ...
    case ServerEventTypes.DATA_CHANNEL_TRANSMISSION:
      resource =
        "runtime/model/channels/data/" + encodeParam(channelId) + "/listener";
      break;
    ...
    default:
      console.error(
        "ERROR: Unknown event type given as a parameter '" + eventType + "'"
      );
      return;
  }
