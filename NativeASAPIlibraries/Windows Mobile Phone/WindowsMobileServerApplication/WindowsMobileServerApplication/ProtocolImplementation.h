...
*
*	This class implement CIM protocol. Class is not finished and needs some changes.
*
*/
...
public:
	...
	char * buildMakeCallPacket(LPTSTR pPhoneID,uint& unBufferSize,bool bAddCRC=true);
	char * buildPhoneStateEventPacket(uint unState, LPTSTR pPhoneID,uint& unBufferSize,bool bAddCRC=true);
	char * buildSendSMSPacket(LPTSTR pPhoneID,LPTSTR pSubject,uint& unBufferSize,bool bAddCRC=true);
	char * buildReceiveSMSEventPacket(LPTSTR pPhoneID,LPTSTR pSubject,uint& unBufferSize,bool bAddCRC=true);
	...
	int getSMSData(char * pBuffer, uint pBufferLength, LPTSTR& pPhoneID,uint& unPhoneIDSize, LPTSTR& pSubject, uint& unSubjectSize);
	int getPhoneIDData(char * pBuffer, uint pBufferLength, LPTSTR& pPhoneID,uint& unPhoneIDSize, uint& unPhoneState);
