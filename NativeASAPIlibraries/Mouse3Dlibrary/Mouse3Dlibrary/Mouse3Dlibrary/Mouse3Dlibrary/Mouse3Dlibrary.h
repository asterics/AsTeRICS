...
#ifdef MOUSE3DLIBRARY_EXPORTS
#define MOUSE3DLIBRARY_API __declspec(dllexport)
#else
#define MOUSE3DLIBRARY_API __declspec(dllimport)
#endif

// This class is exported from the Mouse3Dlibrary.dll
extern "C"
{
