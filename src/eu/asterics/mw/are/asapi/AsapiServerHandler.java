...
/**
 * @author 
 * This class implements the AsapiServer Interface methods 
 * by invoking the corresponding methods in the AsapiSupport 
 * class.
 *  
 * Date: 
 */
...
public class AsapiServerHandler implements AsapiServer.Iface{
	 ...
	 * @param modelInXml	the model in XML to be deployed (as a String) 
	 */
	 ...
	 * @param componentID the component who's ports are to be returned 
	 * @return A list of the component's ports
	 */
	public List<String> GetAllPorts(String componentID) throws AsapiException,
	TException {
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"GetAllPorts: Failed to get all ports -> \n"+e.getMessage());
			throw new AsapiException(0, e.getMessage());
	 ...
	 * @param channelID the channel who's property is to be returned
	...
	throws TException {
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"GetChannelProperty: Failed to get channel property -> \n"+
					e.getMessage());
	...
	throws TException {
		...
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"GetChannelPropertyKeys: Failed to get channel property " +
					"keys-> \n"+e.getMessage());
			throw new TException(e.getMessage());
		}
	...
	/**
	 * Returns a list of the IDs of all the channels that include the
	 * specified component either as a source or target.
	 * @param componentID the ID of the specified component instance
	 * @return a list containing the IDs of all the channels which include
	...
	throws TException {
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"GetComponentProperty: Failed to get component property " +
					"-> \n"+e.getMessage());
			throw new TException(e.getMessage());
		}
	}
	...
	throws TException {
		...
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"GetComponentPropertyKeys: Failed to get component " +
					"property keys -> \n"+e.getMessage());
			throw new TException(e.getMessage());
		}
	}
	...
	/**
	 * Returns a list containing the IDs of all the input ports of the
	...
	throws AsapiException, TException {
		...
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"GetInputPorts: Failed to get input ports -> \n"+
					e.getMessage());
			throw new AsapiException(0, e.getMessage());
		}
	 ...
	 * specified component instance. 
	 * @param componentID the ID of the specified component instance
	 * @return a list containing the IDs of all the output ports of the specified component 
	 * instance
	 */
	...
	throws AsapiException, TException {
		...
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"GetOutputPorts: Failed to get output ports -> \n"+
					e.getMessage());
			throw new AsapiException(0, e.getMessage());
		}
	...
	throws TException {
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"GetPortProperty: Failed to get port property -> \n"+
					e.getMessage());
			throw new TException(e.getMessage());
		}
	}
	 ...
	 */
	public void InsertChannel(String channelID, String sourceComponentID,
			String sourcePortID, String targetComponentID, String targetPortID)
	throws AsapiException, TException {
		try {
			asapiSupport.insertChannel(channelID, sourceComponentID, sourcePortID,
					targetComponentID, targetPortID);
		} catch (AREAsapiException e) {
			logger.warning(this.getClass().getName()+"." +
					"InsertChannel: Failed to insert channel -> \n"+
					e.getMessage());
			throw new AsapiException (0, e.getMessage());
		}
	...
	/**
	 * Creates a new instance of the specified component type, with the
	 * assigned ID.
	...
	throws AsapiException, TException {
		...
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"InsertComponent: Failed to insert component -> \n"+
					e.getMessage());
			throw new AsapiException (0, e.getMessage());
		}
	}
	...
	public void PauseModel() throws AsapiException, TException {
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"PauseModel: Failed to pause model -> \n"+
					e.getMessage());
			throw new TException(e.getMessage());
		}
	...
	@Override
	public ByteBuffer PollData(String courceComponentID,
			String sourceOutputPortID) throws AsapiException, TException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public List<StatusObject> QueryStatus(boolean fullList) throws TException {
		return new ArrayList<StatusObject>
									(Arrays.asList(asapiSupport.queryStatus(fullList)));
	}
	...
	@Override
	public String RegisterRemoteConsumer(String sourceComponentID,
			String sourceOutputPortID) throws AsapiException, TException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public String RegisterRemoteProducer(String targetComponentID,
			String targetInputPortID) throws AsapiException, TException {
		// TODO Auto-generated method stub
		return null;
	}
	 ...
	 */
	public void RemoveChannel(String channelID) throws AsapiException,
	TException {
		try {
			asapiSupport.removeChannel(channelID);
		} catch (AREAsapiException e) {
			logger.warning(this.getClass().getName()+"." +
					"RemoveChannel: Failed to remove channel-> \n"+
					e.getMessage());
			throw new TException (e.getMessage());
		}
	 ...
	 */
	public void RemoveComponent(String componentID) throws AsapiException,
	TException {
		try {
			asapiSupport.removeComponent(componentID);
		} catch (AREAsapiException e) {
			logger.warning(this.getClass().getName()+"." +
					"RemoveComponent: Failed to remove component-> \n"+
					e.getMessage());
			throw new TException (e.getMessage());
		}
	}
	...
	@Override
	public void SendData(String targetComponentID, String targetInputPortID,
			ByteBuffer data) throws AsapiException, TException {
		// TODO Auto-generated method stub
	...
	public String SetComponentProperty(String componentID, String key,
		...
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"SetComponentProperty: Failed to set component " +
					"property -> \n"+e.getMessage());
			throw new TException (e.getMessage());
	...
	public String SetPortProperty(String componentID, String portID,
		...
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"SetPortProperty: Failed to set port " +
					"property -> \n"+e.getMessage());
			throw new TException (e.getMessage());
		}
		//return value;
	...
	public void StopModel() throws AsapiException, TException {
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"StopModel: Failed to stop model -> \n"+e.getMessage());
			throw new TException(e.getMessage());
		}
	...
	/**
	 * Reads the IDs of all properties set for the specified port of the specified component
	 * @param componentID the ID of the port's component
	 * @param portID the ID of the port to be checked
	 * @return a list with all the property keys for the specified port, or null if the 
	...
	throws AsapiException, TException {
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"storeModel: Failed to store model -> \n"+
					e1.getMessage());
	...
	public boolean deleteModelFile(String filename) throws TException {
		try {
			...
			logger.warning(this.getClass().getName()+"." +
					"deleteModelFile: Failed to delete model file -> \n"+
					e.getMessage());
			throw new TException (e.getMessage());
		}
	}
