...
ACS.utils.decodeForXml = function (string) {
...
ACS.utils.encodeForXml = function (string) {
    string = ACS.utils.decodeForXml(string); // if string already has encoded chars -> decode them, prevents double-encoding
	return string.replace(/&/g, '&amp;')
        .replace(/</g, '&lt;')
        .replace(/>/g, '&gt;')
        .replace(/"/g, '&quot;')
