...
//	CIMPortController  port = null;
	...
	private void initDisplay()
	{
		...
		if (CIMPortManager.getInstance().getConnection(CORE_CIM_ID) != null)
		{
			...
			CIMPortManager.getInstance().getConnection(CORE_CIM_ID)
				.addEventListener(cimListener);
			setupDisplayCIM();
			setupGui();
			if (enableHeartBeat)
			{
					...
					new Runnable()
					{
						...
						public void run() 
						{
							try {
								...
								while (true)
								{
									CIMPortManager.getInstance().sendPacket(
											CORE_CIM_ID, 
											null, 
											CIMProtocolPacket.FEATURE_UNIQUE_SERIAL_NUMBER, 
											CIMProtocolPacket.COMMAND_REQUEST_READ_FEATURE, 
											false);
									Thread.sleep(2000);
								}
	...
	int writeToDisplay(short feature, byte [] data)
	{
		if (displayAvailable)
		{
			return CIMPortManager.getInstance().sendPacket(
					CORE_CIM_ID, 
					data, 
					feature, 
					CIMProtocolPacket.COMMAND_REQUEST_WRITE_FEATURE, 
					false);
		}
		return -1;
	}
	...
	void setupGui()
	{
		...
		DisplayNavigationButton btnUp = 
			new DisplayNavigationButton("up", 79, 48, 16, 16, NavigationDirection.UP);
		...
		DisplayNavigationButton btnDown = 
			new DisplayNavigationButton("dn", 95, 48, 16, 16, NavigationDirection.DOWN);
		...
		DisplayNavigationButton btnBack = 
			new DisplayNavigationButton("bk", 0, 48, 16, 16, NavigationDirection.BACK);
	...
	public void addGuiSlider(String menuTitle, String sliderTitle, Double initValue, 
			Double stepSize, Double lowerBoundary, Double upperBoundary, IGuiChangeListener listener)
	{
//		DisplayButton mainMenuItem = new DisplayButton(menuTitle, 0, 0, DISPLAY_WIDTH, 16);
//		final DisplayListCanvas dlcCanvas = new DisplayListCanvas("  " + sliderTitle, 0,0,DISPLAY_WIDTH, 48);
		modelCanvas.addChild(new DisplayLabel("* " +
				sliderTitle, 0, 0, DISPLAY_WIDTH, 16));
...
/*		
		mainMenuItem.addEventListener(new IDisplayEventListener()
		{
			...
			public void action() 
			{
				rootCanvas.displayCanvas(dlcCanvas);
			}
		}
		);
...
//			System.out.println("Incoming packet: " +  p.toString());
	...
	byte playIconData[]= { 
			 ...
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
	...
	byte stopIconData[]={
			 ...
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x5f, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
	...
	byte upIconData[]={
			 ...
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0x5f, (byte) 0xf5, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0xf5, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0x55, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
	...
	byte backIconData[]={
			 ...
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0x5f, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0xff, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0x5f, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0x5f, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0x55, (byte) 0xf5, (byte) 0x3f,
			 (byte) 0xf3, (byte) 0xff, (byte) 0x5f, (byte) 0x55, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x3f,
	...
	/**
	 * Callback when system is entering standby. Will display standby 
	 * activation message label
	 */
