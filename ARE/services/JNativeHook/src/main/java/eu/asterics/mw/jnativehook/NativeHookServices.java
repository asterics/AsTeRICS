...
/**
 * Helper class to init the jnativehook classes. This is needed because
 * otherwise each plugin using jnativehook would redundantly call
 * registerNativeHook. Also implements a NativeKeyListener and registers hotkeys
 * to start, pause or stop a model.
 * 
 * @author mad
 *
 */
public class NativeHookServices implements NativeKeyListener {
    ...
    /**
     * A private helper method that cleans up the temporarily created dlls which
     * where extracted from the jar.
     */
