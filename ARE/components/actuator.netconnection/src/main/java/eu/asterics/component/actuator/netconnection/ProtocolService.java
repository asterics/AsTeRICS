...
/**
 * 
 * This class implements the communication protocol for the NetConnection
 * plugin.
 * 
...
public class ProtocolService {
     ...
     * 
     * @param first
     *            high bite of the size
     * @param second
     *            low byte of the size
     * @return data size
     */
    ...
    public HeaderInfo getHeader() {
        try {
            ...
            if ((header[0] == firstByte) && (header[1] == secondByte)) {
                ...
                /*
                 * if(command==Command.None) { //TODO }
                 * 
                 * if(checkCommandData(command)==false && dataSize>0) { //TODO }
                 */
    ...
    /**
     * Returns true if the header was received. Last getHeader call was
     * successful.
     * 
