...
/**
 * 
 * This class implements component which allows to pass data through the network between AREs and applications which use Native ASAPI DLL library.
 *  
...
public class NetConnectionInstance extends AbstractRuntimeComponentInstance
{
    ...
    */
    public NetConnectionInstance()
    {
        ...
        communicationManager=new CommunicationManager(etpOutputEventArray,opIntegerOutputPortArray,opDoubleOutputPortArray,opStringOutputPortArray);
    }
