...
public class GUI extends JPanel {
    ...
    private void design(int width, int height) {
        ...
        switch (position) {
        case Left:
            textLabel = new JLabel(owner.getDefaultText(), SwingConstants.LEFT);
            break;
        case Center:
            textLabel = new JLabel(owner.getDefaultText(), SwingConstants.CENTER);
            break;
        case Right:
            textLabel = new JLabel(owner.getDefaultText(), SwingConstants.RIGHT);
            break;
        default:
            textLabel = new JLabel(owner.getDefaultText(), SwingConstants.CENTER);
        }
