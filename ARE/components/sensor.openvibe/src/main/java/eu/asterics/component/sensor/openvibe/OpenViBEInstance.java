 ...
 * 
 *  
 * @author Rene Hirtl [rene.hirtl@technikum-wien.at]
 *         Date: Apr 25, 2012
 *         Time: 4:36:00 PM
 */
    ...
    */
    ...
    public Object setRuntimePropertyValue(String propertyName, Object newValue)
    {
      ...
      */
      ...
      public void start()
      {
    	  //AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format("Start"));
      ...
      */
  	...
  	public static void server( String protocol )
  	{
  		...
  		try
  		{
  			...
  			//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, "BufferSize");
  			//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.valueOf(OpenViBEInstance.instance.c.getBufferSize()));
  		...
  		{
  			/*public void messageReceived( OSCBundle bndl, SocketAddress addr, long time )
  			{
  			...
  			*/
  			...
  			{
  	  			//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.valueOf(blubvar));
  				
  				//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.valueOf(time));
  				//bndl = new OSCBundle();
  				
  				/*if(timeStamp < OpenViBEInstance.instance.ChannelCount)
  				{
  					msgBuffer[msgCount] = m;
  					msgCount++;
  					timeStamp++;
  				}
  				else
  				...
  				*/
  				...
  				//OpenViBEInstance.instance.opCH13.sendData(ConversionUtils.doubleToBytes((double) time));
  				...
  				/*try
  				{
  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format( "send "+addr ));
  					//OpenViBEInstance.instance.c.send( new OSCMessage( "/done", new Object[] { m.getName(), m.getArg(0), m.getArg(1), m.getArg(2), m.getArg(3) }), addr );
  					OpenViBEInstance.instance.c.send( new OSCMessage( "/done", new Object[] { m.getName() }), addr );
  				}
  				catch( IOException e1 )
  				{
  					e1.printStackTrace();
				...
				try
				{
					...
					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.valueOf(size));
					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.valueOf(sizeAddress));
				}
				...
				{
	  				OpenViBEInstance.instance.opCH1.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
				}*/
				
				/*for(count = 0; count < ((size-sizeAddress)/5); count++)
				{
	  				OpenViBEInstance.instance.ReceiveBuffer[0][OpenViBEInstance.instance.ReceiveBufferCount] = (float) m.getArg(count);
	  				OpenViBEInstance.instance.ReceiveBuffer[1][OpenViBEInstance.instance.ReceiveBufferCount] = (float) time;
	  				...
	  				if(OpenViBEInstance.instance.ReceiveBufferCount >= 1024)
	  				{
	  					...
	  					{
	  						OpenViBEInstance.instance.opCH13.sendData(ConversionUtils.doubleToBytes(OpenViBEInstance.instance.ReceiveBuffer[0][OpenViBEInstance.instance.ReceiveBufferCount]));
	  						OpenViBEInstance.instance.opCH14.sendData(ConversionUtils.doubleToBytes(OpenViBEInstance.instance.ReceiveBuffer[1][OpenViBEInstance.instance.ReceiveBufferCount]));
	  					}
	  				}
				}*/
				
  				
				//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, m.getName());
				...
				if(m.getName().contains("bundle"))
				...
				else if(m.getName().equals("/SamplingFrequency"))
  				{
  					...
  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.valueOf(OpenViBEInstance.instance.SamplingFrequency));
  					//OpenViBEInstance.instance.opCH2.sendData(ConversionUtils.intToBytes((int) m.getArg(0)));
  					
  					//Set defaul value, if necessary
  					if(OpenViBEInstance.instance.SamplingFrequency == 0) OpenViBEInstance.instance.SamplingFrequency = 128;
  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.valueOf(OpenViBEInstance.instance.SamplingFrequency));
  				}
				else if(m.getName().equals("/ChannelCount"))
  				{
  					OpenViBEInstance.instance.ChannelCount = (int) m.getArg(0);
  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.valueOf(OpenViBEInstance.instance.ChannelCount));
  				}
  				else if(m.getName().startsWith("/Signal"))
  				{
  					
  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, "Signal");
  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, m.getName());
  					
  					if(m.getName().contains(String.valueOf(1)))
  					{
  						//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, "CH1");
	//	  				System.out.println("Ch1 data size:"+ (size-sizeAddress)/5);
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH1.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  		  					 System.out.print("*");
  		...
  		/*  					
  		  			        final long end = System.nanoTime() + 500000;
  		  			        long timeLeft;
  		  			        do {
  		  			                    Thread.yield();
...
*/
  		  			...
  		  			//} catch (InterruptedException e) {}
  		  					...
  		  					//OpenViBEInstance.instance.opCH14.sendData(ConversionUtils.doubleToBytes((double) time));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(2)))
  					{
  						//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, "CH2");
	//	  				System.out.println("Ch2 data size:"+ (size-sizeAddress)/5);

  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH2.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
 /*  		  			        final long end = System.nanoTime() + 500000;
  		  			        long timeLeft;
  		  			        do {
  		  			                    Thread.yield();
...
*/
  					...
  					else if(m.getName().contains(String.valueOf(3)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH3.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(4)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH4.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(5)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH5.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(6)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH6.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(7)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH7.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(8)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH8.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(9)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH9.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(10)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH10.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(11)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH11.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(12)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH12.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(13)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH13.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(14)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH14.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(15)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH15.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  					else if(m.getName().contains(String.valueOf(16)))
  					{
  	  					for(count = 0; count < ((size-sizeAddress)/5); count++)
  	  					{
  		  					OpenViBEInstance.instance.opCH16.sendData(ConversionUtils.doubleToBytes((float) m.getArg(count)));
  	  					}
  					}
  				...
  				else if(m.getName().contains("/Stimulation"))
  				{
  					...
  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format( "Stimulation" ));
  					...
  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format(m.getName()));
  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format(StimulationID));
  					
  					if(m.getName().contains("P300"))
  					{
	  					
	  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format("P300"));
	  					
	  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format(StimulationID.substring(26)));
	  					
	  					int value = 0;
	
	  					if(StimulationID.substring(26).contains("C")) value = 12;
	  					else if(StimulationID.substring(26).contains("B")) value = 11;
	  					else if(StimulationID.substring(26).contains("A")) value = 10;
	  					else if(StimulationID.contains("OVTK_StimulationId_Label")) value = Integer.parseInt(StimulationID.substring(26));
	  					
	  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format(Integer.toString(value)));
	  					
	  					if((value >= 1)&&(value < 7)) StimulationID1 = StimulationID;
	  					else if((value >= 7)&&(value < 13)) StimulationID2 = StimulationID;
	  					
	  					
	  					//if((ConversionUtils.intFromBytes(ConversionUtils.stringToBytes(StimulationID.substring(26, 27))) >= 1) && (ConversionUtils.intFromBytes(ConversionUtils.stringToBytes(StimulationID.substring(26, 27))) < 7)) StimulationID1 = StimulationID;
	  					//else if((ConversionUtils.intFromBytes(ConversionUtils.stringToBytes(StimulationID.substring(26, 27))) >= 7) && (ConversionUtils.intFromBytes(ConversionUtils.stringToBytes(StimulationID.substring(26, 27))) < 13)) StimulationID2 = StimulationID;
	  					//else StimulationID2 = StimulationID;
	  					
	  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format(StimulationID.substring(25, 27)));
	  					
	  					
	  					//if second stimulation was sent
	  					if(m.getName().contains("/Stimulation") && StimulationID1 != "" && StimulationID2 != "")
	  					{
	  						//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format("blub2"));
	  						
	  						//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format("Second stimulation!"));
	  						//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format(StimulationID1));
	  	  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format(StimulationID2));
	  				...
	  				{
	  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format("SSVEP"));
		  				if(StimulationID.contains("OVTK_StimulationId_Label_00")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_00.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_01")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_01.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_02")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_02.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_03")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_03.raiseEvent();
	  				}
	  				else
	  				{
	  					//AstericsErrorHandling.instance.reportInfo(OpenViBEInstance.instance, String.format("Misc"));
	  					
		  				if(StimulationID.contains("OVTK_StimulationId_Label_00")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_00.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_01")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_01.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_02")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_02.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_03")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_03.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_04")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_04.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_05")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_05.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_06")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_06.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_07")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_07.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_08")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_08.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_09")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_09.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_0A")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_0A.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_0B")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_0B.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Label_0C")) OpenViBEInstance.instance.etpOVTK_StimulationId_Label_0C.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_Target")) OpenViBEInstance.instance.etpOVTK_StimulationId_Target.raiseEvent();
		  				if(StimulationID.contains("OVTK_StimulationId_NonTarget")) OpenViBEInstance.instance.etpOVTK_StimulationId_NonTarget.raiseEvent();			
	  				}
