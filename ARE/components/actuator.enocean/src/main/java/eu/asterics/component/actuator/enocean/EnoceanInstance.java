        ...
        public void receiveData(byte[] data) {
            ...
            if (text.startsWith("@ENOCEAN:")) {
                try {
                    ...
                    // StringTokenizer(text.substring(5),"#");
        ...
        try {
            ...
            if (propUSB == false) {
                ...
                if (portController == null) {
                    System.out.println("Port controller ist null....");
                }
                if (portController.getInputStream() == null) {
                    System.out.println("Port controller InputStream ist null....");
                }
                if (portController.getOutputStream() == null) {
                    System.out.println("Port controller OutputStream ist null....");
                }
            ...
            enoceanLink.addLinkListener(new ILinkListener() {
                ...
                @Override
                public void frameReceived_GatewayID(FrameEventGetGatewayID arg0) {
                    // not necessary...
                ...
                @Override
                public void frameReceived_Illumination(FrameEventIllumination arg0) {
                    String temp = String.valueOf(arg0.getIlluminationValue());

                    if (arg0.getDeviceID().equals(propIDTrigger1)
                            && "illumination".equalsIgnoreCase(propTypeTrigger1)) {
                        opValue1.sendData(temp.getBytes());
                        runtimeEventTriggererPort1.raiseEvent();
                    }
                    if (arg0.getDeviceID().equals(propIDTrigger2)
                            && "illumination".equalsIgnoreCase(propTypeTrigger2)) {
                        opValue2.sendData(temp.getBytes());
                        runtimeEventTriggererPort2.raiseEvent();
                    }
                    if (arg0.getDeviceID().equals(propIDTrigger3)
                            && "illumination".equalsIgnoreCase(propTypeTrigger3)) {
                        opValue3.sendData(temp.getBytes());
                        runtimeEventTriggererPort3.raiseEvent();
                    }
                    if (arg0.getDeviceID().equals(propIDTrigger4)
                            && "illumination".equalsIgnoreCase(propTypeTrigger4)) {
                        opValue4.sendData(temp.getBytes());
                        runtimeEventTriggererPort4.raiseEvent();
                    }
                    if (arg0.getDeviceID().equals(propIDTrigger5)
                            && "illumination".equalsIgnoreCase(propTypeTrigger5)) {
                        opValue5.sendData(temp.getBytes());
                        runtimeEventTriggererPort5.raiseEvent();
                    }
                    if (arg0.getDeviceID().equals(propIDTrigger6)
                            && "illumination".equalsIgnoreCase(propTypeTrigger6)) {
                        opValue6.sendData(temp.getBytes());
                        runtimeEventTriggererPort6.raiseEvent();
                    }
                }
                ...
                @Override
                public void frameReceived_LearnTelegram(FrameEventLearnTelegram arg0) {
                    // not necessary...
                ...
                @Override
                public void frameReceived_SupplyVoltage(FrameEventSupplyVoltage arg0) {
                    // not implemented

                }

                @Override
                public void frameReceived_Temperature(FrameEventTemperature arg0) {
                ...
                @Override
                public void frameReceived_WindowHandle(FrameEventWindowHandle arg0) {
                    // TODO to be done...
        ...
        if (enoceanLink != null) {
            ...
            case "binary":
                if (value.equalsIgnoreCase("true")) {
                    enoceanLink.sendEvent(EventSend.BINARY_EVENT, Integer.parseInt(id), BinaryState.TRUE,
                            BinaryState.UNKNOWN, BinaryState.UNKNOWN, BinaryState.UNKNOWN);
                } else {
                    enoceanLink.sendEvent(EventSend.BINARY_EVENT, Integer.parseInt(id), BinaryState.FALSE,
                            BinaryState.UNKNOWN, BinaryState.UNKNOWN, BinaryState.UNKNOWN);
                }
                break;
            case "temperature":
                enoceanLink.sendEvent(EventSend.TEMPERATURE_EVENT, Integer.parseInt(id), Float.parseFloat(value));
                break;
            case "illumination":
                enoceanLink.sendEvent(EventSend.ILLUMINATION_EVENT, Integer.parseInt(id), Float.parseFloat(value));
                break;
            case "fan":
                // TODO
                break;
            case "humidity":
                enoceanLink.sendEvent(EventSend.HUMIDITY_EVENT, Integer.parseInt(id), Float.parseFloat(value));
                break;
            case "setpoint":
                enoceanLink.sendEvent(EventSend.SETPOINT_EVENT, Integer.parseInt(id), Float.parseFloat(value));
                break;
            default:
                break;
            }
