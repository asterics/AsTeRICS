...
public class GuiTesterInstance extends AbstractRuntimeComponentInstance {
    ...
    private final IRuntimeInputPort chn1InputPort = new DefaultRuntimeInputPort() {
        @Override
    ...
    private final IRuntimeInputPort chn2InputPort = new DefaultRuntimeInputPort() {
        @Override
        public void receiveData(byte[] data) {
            ;
        }
    ...
    public void start() {
        ...
        // method. Plugin GUIs should be constructed in dependence of this
        // space.
