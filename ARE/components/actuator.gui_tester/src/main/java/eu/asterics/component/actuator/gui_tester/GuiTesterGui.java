...
/**
 * @author Konstantinos Kakousis This class generates a JPanel to be displayed
 *         on the AsTeRICS Desktop. It can be used as a prototype from
 *         developers interested in creating plugins with gui elements. This
 *         plugin includes several Swing components as well as Graphics.
 *         Everything is defined in terms of available space which is passed as
...
public class GuiTesterGui extends JPanel {
    ...
    private JPanel leftPanel, topPanel, centerPanel, bottomPanel, internalCenterPanel, rightPanel, nameLabelPanel;
    private JLabel title, nameLabel, notesLabel, checkBoxesLabel, sliderLabel;
    private JTextField nameField;
    private Dimension topPanelSize, bottomPanelSize, leftPanelSize, rightPanelSize, centerPanelSize;
     ...
     * 
     * @param space
     *            The available space as it can be retrieved from the ARE:
    ...
    private void design(int width, int height) {
        ...
        AREServices.instance.adjustFonts(this, MAX_FONT_SIZE, MIN_FONT_SIZE, OFFSET);
        ...
        rightPanel.addHierarchyListener(new HierarchyListener() {
            ...
            public void hierarchyChanged(HierarchyEvent e) {
                if ((HierarchyEvent.SHOWING_CHANGED & e.getChangeFlags()) != 0 && rightPanel.isShowing()) {
                    ...
                    newPanel.repaint(rightPanel.getX(), rightPanel.getY(), rightPanelSize.width, rightPanelSize.height);
                    rightPanel.repaint();
    ...
    /**
     * All panel sizes are defined in terms of the available space! This is
     * essential to keep the GUI elements adjustable to changing available space
     * on the Desktop. It is important to define preferred sizes for JPanels
     * since the can affect the font resizing procedure which the ARE services
     * provide using <code>AREServices.instance.adjustFonts</code>
     * 
     * @param width
     * @param height
     */
     ...
     * style. It is used to demonstrate how Swing components can be created in a
     * way adjustable to changing sizes.
     */
    private void setLeftPanel() {
        ...
        nameLabelPanel.setLayout(new BoxLayout(nameLabelPanel, BoxLayout.Y_AXIS));
        nameLabelPanel.setPreferredSize(new Dimension(leftPanelSize.width, (int) (leftPanelSize.height * 0.08)));
        ...
        // Slider
        slider = new JSlider(SwingConstants.HORIZONTAL, 0, leftPanelSize.width, leftPanelSize.width / 6);
        slider.setPaintTicks(true);
        slider.setPaintLabels(true);
        slider.setAlignmentX(java.awt.Component.LEFT_ALIGNMENT);

        JPanel sliderLabelPanel = new JPanel();
        sliderLabelPanel.setLayout(new BoxLayout(sliderLabelPanel, BoxLayout.Y_AXIS));
        sliderLabelPanel.setPreferredSize(new Dimension(leftPanelSize.width, (int) (leftPanelSize.height * 0.08)));
        ...
        notesLabelPanel.setPreferredSize(new Dimension(leftPanelSize.width, (int) (leftPanelSize.height * 0.08)));
        notesLabelPanel.setLayout(new BoxLayout(notesLabelPanel, BoxLayout.Y_AXIS));
    ...
    private void setCenterPanel() {
        ...
        internalCenterPanel.setLayout(new BoxLayout(internalCenterPanel, BoxLayout.Y_AXIS));
        internalCenterPanel.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 10));

        JPanel checkBoxesLabelPanel = new JPanel();
        checkBoxesLabelPanel.setLayout(new BoxLayout(checkBoxesLabelPanel, BoxLayout.Y_AXIS));
        ...
        checkBoxesLabelPanel
                .setPreferredSize(new Dimension(centerPanelSize.width, (int) (centerPanelSize.height * 0.08)));
