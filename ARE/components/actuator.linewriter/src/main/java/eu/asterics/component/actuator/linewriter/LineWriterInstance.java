    ...
    private final IRuntimeInputPort ipActLine = new DefaultRuntimeInputPort() {
        ...
        public void receiveData(byte[] data) {
            ...
            try {
                ...
                case 0:
                    out.write(valueToWrite + newline);
                    break;
                case 1:
                    out.write((System.currentTimeMillis() - starttime) + ", " + valueToWrite + newline);
                    break;
                }
            } catch (IOException e) {
        ...
        try {
            if (propAddTimeToFileName) {
                out = new BufferedWriter(
                        new FileWriter(propFileName + "_" + sdf.format(cal.getTime()) + ".txt", propAppend));
            } else {
