...
/**
 * 
 * This module allows control of radio-controlled toy models via the Walkera
 * MTC-01 (Magic Cube) which is connected to a teensy micorcontroller running
 * the Teensy_RC_CIM firmware
 * 
 * 
 * @author Alexander Frimmel Date: 02/2014 Time:
 */
public class TeensyRCprototypeInstance extends AbstractRuntimeComponentInstance {
    ...
    public void start() {
        ...
        if (port != null) {
            ...
            AstericsErrorHandling.instance.reportError(this, String.format(
                    "Could not get port controller for TeensyRC CIM, please make sure the TeensyRC module is connected to a USB port. "));
        }
