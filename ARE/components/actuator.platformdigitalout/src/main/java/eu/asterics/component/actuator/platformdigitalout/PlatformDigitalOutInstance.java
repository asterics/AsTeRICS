 ...
 * 
 * The class can work with incoming commands prepended with "@GPIO:". The
 * available commands are "set" for setting, "clear" for clearing and "toggle"
 * for inverting an output. The example syntax of a command is "@GPIO:set,1".
 * 
...
public class PlatformDigitalOutInstance extends AbstractRuntimeComponentInstance {
    ...
    /**
     * The base constructor opens the connection to the CIM and creates all port
     * instances.
     * 
     */
    ...
    public void start() {
        ...
        AstericsErrorHandling.instance.reportInfo(this, "PlatformDigitalOut started");
    }
    ...
    public void stop() {
        super.stop();
        AstericsErrorHandling.instance.reportInfo(this, "PlatformDigitalOut stopped");
    }
    ...
    class RuntimeEventListenerPortHigh implements IRuntimeEventListenerPort {
         ...
         * 
         * @param owner
         *            the CoreCimGpioOutputInstance instance that owns this
         * @param i
        ...
        public void receiveEvent(final String data) {
            AstericsErrorHandling.instance.reportInfo(owner,
                    String.format("Received event on high listener port #" + index));
    ...
    class RuntimeEventListenerPortLow implements IRuntimeEventListenerPort {
        ...
        public void receiveEvent(final String data) {
            AstericsErrorHandling.instance.reportInfo(owner,
                    String.format("Received event on low listener port #" + index));
            owner.setOutputBitLow(index);
        }
    }

    private final IRuntimeInputPort ipCommandPort = new DefaultRuntimeInputPort() {
        @Override
