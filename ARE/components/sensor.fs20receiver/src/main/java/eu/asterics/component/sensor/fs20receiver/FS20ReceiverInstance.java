 ...
 * The plugin opens a connection to the USB Receiver "FS20 PCE" and fire an event
 * if the received command fits to the set housecode and sender address. 
 * 
 * 
 *  
...
public class FS20ReceiverInstance extends AbstractRuntimeComponentInstance {
    ...
    */
    ...
    public Object setRuntimePropertyValue(String propertyName, Object newValue)
    {
     ...
     /**
      * parsing the input message from the receiver
      * firstly, the housecode and the senderaddress will be checked,
      * then the event regarding to the command will be fired
      */
