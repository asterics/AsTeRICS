...
public class SkyWatcherMountInstance extends AbstractRuntimeComponentInstance implements PositionEventListener
{
    ...
    */
     ...
     */
    private final IRuntimeInputPort ipSpeedPort
	...
	private final IRuntimeInputPort ipEndPointLeft
            = new DefaultRuntimeInputPort()
    {
        public void receiveData(byte[] data) 
        {
	...
	private final IRuntimeInputPort ipEndPointRight
            = new DefaultRuntimeInputPort()
    {
        public void receiveData(byte[] data) 
        {
	...
	private final IRuntimeInputPort ipEndPointUp
            = new DefaultRuntimeInputPort()
    {
        public void receiveData(byte[] data) 
        {
	...
	private final IRuntimeInputPort ipEndPointDown
            = new DefaultRuntimeInputPort()
    {
        public void receiveData(byte[] data) 
        {
    ...
    public Object setRuntimePropertyValue(String propertyName, Object newValue)
    {
		...
		/*if ("EndPointLeft".equalsIgnoreCase(propertyName))
		{
			maxLeft = Integer.parseInt(newValue.toString());
			if (skyWatcher == null) {
				return null;  
			}
			skyWatcher.setMaxLeft(maxLeft);
		...
		if ("EndPointRight".equalsIgnoreCase(propertyName))
		{
			maxRight = Integer.parseInt(newValue.toString());
			if (skyWatcher == null)
				return null;
			skyWatcher.setMaxRight(maxRight);
			return null;
		}
		if ("EndPointUp".equalsIgnoreCase(propertyName))
		{ 
			maxUp = Integer.parseInt(newValue.toString());
			if (skyWatcher == null)
				return null;
			skyWatcher.setMaxUp(maxUp);
			return null;
		}
		if ("EndPointDown".equalsIgnoreCase(propertyName))
		{
			maxDown = Integer.parseInt(newValue.toString());
			if (skyWatcher == null)
				return null;
			skyWatcher.setMaxDown(maxDown);
			return null;
