...
/**
 *   Implements the comparator plugin, compares two input signals
 *   and generates events on different conditions like "greater", 
 *   "equal", "less", "difference greater than", etc.
 *   The output of a signal can be set to max, min, or to 
 *   "signalA if condition is true".
 *  
 * 
