...
public class DataTypeInstance extends AbstractRuntimeComponentInstance {
    ...
    @Override
    public void start() {
        opOutBoolean.sendData(ConversionUtils.convertData(ConversionUtils.doubleToBytes(propOutValue),
                ConversionUtils.DOUBLE_TO_BOOLEAN));
        opOutByte.sendData(ConversionUtils.convertData(ConversionUtils.doubleToBytes(propOutValue),
                ConversionUtils.DOUBLE_TO_BYTE));
        opOutChar.sendData(ConversionUtils.convertData(ConversionUtils.doubleToBytes(propOutValue),
                ConversionUtils.DOUBLE_TO_CHAR));
        opOutDouble.sendData(ConversionUtils.doubleToBytes(propOutValue));
        opOutInteger.sendData(ConversionUtils.convertData(ConversionUtils.doubleToBytes(propOutValue),
                ConversionUtils.DOUBLE_TO_INTEGER));
        opOutString.sendData(ConversionUtils.convertData(ConversionUtils.doubleToBytes(propOutValue),
                ConversionUtils.DOUBLE_TO_STRING));
        super.start();
    }
