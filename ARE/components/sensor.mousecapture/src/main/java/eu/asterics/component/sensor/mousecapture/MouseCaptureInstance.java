...
/**
 *   MouseCaptureInstance intercepts local mouse input and 
 *   routes the mouse actions to output ports of the plugin
 *  
...
public class MouseCaptureInstance extends AbstractRuntimeComponentInstance
{
	...
	private final Bridge bridge = new Bridge(opMouseX, opMouseY,
			etpLeftButtonPressed,etpLeftButtonReleased,etpRightButtonPressed,etpRightButtonReleased,
