...
package eu.asterics.component.processor.multisourcestring;
...
/**
 * 
 * This plugin passes strings from the four input ports to the one output port.
 * 
 * @author Karol Pecyna [kpecyna@harpo.com.pl] Date: Mar 27, 2011 Time: 11:27:12
 *         AM
 */

public class MultiSourceStringInstance extends AbstractRuntimeComponentInstance {
     ...
     */
    public MultiSourceStringInstance() {
        // empty constructor
    }
    ...
    private final IRuntimeInputPort ipInput1 = new DefaultRuntimeInputPort() {
        ...
        public void receiveData(byte[] data) {
            ...
            try {
                lock.lock();
                opOutput.sendData(ConversionUtils.stringToBytes(inputString));
            } finally {
                lock.unlock();
            }
        }
