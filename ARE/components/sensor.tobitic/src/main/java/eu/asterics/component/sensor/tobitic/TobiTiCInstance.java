...
/**
 * 
 * This module implements a simple intrface to the TOBI TiC see
 * http://files.mtvl.org/projects/tobicore/doc/libtobiic.pdf
 * http://www.bcistandards.org/softwarestandards/tic
 * 
 * up to five class values (names given as properties) are presented at the
 * plugin's output ports
 * 
 * @author chris veigl [veigl@technikum-wien.at] Date: Oct. 30, 2012 Time:
 */
public class TobiTiCInstance extends AbstractRuntimeComponentInstance {
    ...
    @Override
    public void stop() {
        AstericsErrorHandling.instance.reportInfo(this, String.format("Closing Connection to TiC"));
    ...
    void closeConnection() {
        if (connectionEstablished) {
            AstericsErrorHandling.instance.reportInfo(instance, String.format("Closing Connection to TiC Interface"));
     ...
     * communication with the Tobi Tic interface. This class handles all
     * incoming packets as well as the set up and tear down of the connection.
     * 
     */
    class TobiTicConnectionListener implements IRemoteConnectionListener {
        ...
        public void connectionEstablished() {
            ...
            connectionEstablished = true;
            // boolean ret =
            // RemoteConnectionManager.instance.writeData(Integer.toString(tcpPort),
            // message.getBytes());
        ...
        public void dataReceived(byte[] data) {
            ...
            if (delimiterPos > -1) // one complete message available
            {
                ...
                try {
                    /*
                     * input = "<tobiic version=\"0.1.1.0\" frame=\"1\">\n"+
