...
/**
 * 
 * RFIDReaderInstance interfaces to the IDinnovations RFID-Reader via a raw com
 * port. A recgnized tag-ID is sent to the output port as a string.
 * 
 * 
 * @author <Chris Veigl> [veigl@technikum-wien.at]
 * 
 */
public class RFIDReaderInstance extends AbstractRuntimeComponentInstance implements CIMEventHandler {
