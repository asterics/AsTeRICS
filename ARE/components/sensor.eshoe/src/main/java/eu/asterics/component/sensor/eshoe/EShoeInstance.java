    ...
    */
		...
		try
		{
			...
			else
			{
				AstericsErrorHandling.instance.reportError(this, 
				   		 "eShoe: Error Starting: Sampling Rate is not set");
				return;
			}
			out.write(message);
		}
	...
	void parseOutputPacket()
	{
		try
		{
		    ...
		    //System.out.println("Read values: Channel1 " + datavalue[0] +",Channel2: " + datavalue[1] +",Channel3: " + datavalue[2] +",Channel4: " + datavalue[3]+",Channel5: " + datavalue[4]+",Channel6: " + datavalue[5]);
		} 
		catch (Exception e)
		{
	...
	public void handlePacketReceived(byte data)
	{
		...
		//System.out.println("val = " + Integer.toHexString(0x000000ff & data) +" hex; pos:" + position + "; length: " + length +"; index:" + i );
