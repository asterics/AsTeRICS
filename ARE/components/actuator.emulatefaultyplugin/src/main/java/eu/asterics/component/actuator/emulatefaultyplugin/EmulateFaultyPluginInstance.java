...
/**
 * The idea of the module is to emulate failure situations during the lifecycle
 * of a module. This includes start/pause/resume/stop, receiving data input and
 * events or receiving/returning new property values.
 * 
 * @author Martin Deinhofer [martin.deinhofer@technikum-wien.at] Date:
 *         23.02.2015 Time: 09:30
 */
public class EmulateFaultyPluginInstance extends AbstractRuntimeComponentInstance {
    ...
    // Indicates whether the thread that emulates a hanging call should be
    // stopped.
    ...
    public IRuntimeInputPort getInputPort(String portID) {
         ...
         * if(propGetInputPortNullValue) { return null; }
         */
    ...
    public IRuntimeOutputPort getOutputPort(String portID) {
         ...
         * ); if(propGetOutputPortNullValue) { return null; }
         */
    ...
    public IRuntimeEventListenerPort getEventListenerPort(String eventPortID) {
        /*
         * handleCall(0,propGetEventListenerPortException,
         * "Exception in getEventListenerPort");
         * if(propGetEventListenerPortNullValue) { return null; }
         */
    ...
    public Object getRuntimePropertyValue(String propertyName) {
         ...
         * 
         * handleCall(propGetRuntimePropertyDuration,
         * propGetRuntimePropertyValueException,
         * "Exception in getRuntimePropertyValue");
         * if(propGetRuntimePropertyNullValue) { return null; }
         */
    ...
    public Object setRuntimePropertyValue(String propertyName, Object newValue) {
         ...
         * 
         * if(!"setRuntimePropertyValueException".equalsIgnoreCase(propertyName)
         * && !"setRuntimePropertyDuration".equalsIgnoreCase(propertyName)) {
         * handleCall(propSetRuntimePropertyDuration,
         * propSetRuntimePropertyValueException,
         * "Exception in setRuntimePropertyValue"); }
         */
    ...
    private Object handleCall(final int duration, boolean throwException, String exceptionMessage,
            boolean returnNullValue) {

        AstericsErrorHandling.instance.getLogger().fine("handleCall: duration: " + duration + ", throw Exception: "
                + throwException + ", exceptionMessage: " + exceptionMessage + ", returnNullValue: " + returnNullValue);
        if (throwException) {
            AstericsErrorHandling.instance.getLogger()
                    .warning("Before entering throwing exception with message: " + exceptionMessage);
            ...
            if (duration == -1) {
                ...
                /*
                 * try { File tmpFile=File.createTempFile("AREhang", "tmp");
                 * FileInputStream fi=new FileInputStream(tmpFile);
                 * AstericsErrorHandling.instance.getLogger().warning(
                 * "Before reading file"); int nrBytes=fi.read(new
                 * byte[100],0,100);
                 * AstericsErrorHandling.instance.getLogger().warning(
                 * "After reading file: nrBytes: "+nrBytes); } catch
