...
public class RemoteWindowInstance extends AbstractRuntimeComponentInstance
{
   ...
   public interface User32 extends StdCallLibrary {
	...
	{
			User32.INSTANCE.SetWindowPos(hWnd, null, propXPos, propYPos,0,0,User32.INSTANCE.SWP_NOSIZE);
	}
	private void moveNativeWindowToTop(Pointer hWnd)
	{
	      ...
	      if (result != 0) {
				...
				int yPos=propYPos;
  			User32.INSTANCE.SetWindowPos(hWnd, null, xPos,yPos,0,0,User32.INSTANCE.SWP_NOSIZE);
	      }
	}
	...
	{
		User32.INSTANCE.ShowWindow(hWnd, User32.INSTANCE.SWP_MINIMIZE); 
	}
	private void restoreNativeWindow(Pointer hWnd)
	{
		User32.INSTANCE.ShowWindow(hWnd, User32.INSTANCE.SWP_RESTORE); 
	}
     /**
			   ...
			   final User32 user32 = User32.INSTANCE;
				...
				if (propMode==MODE_EXACT_MATCH)
				{
					//System.out.println("Try to find Window "+propWindowName);
	       			Pointer hWnd = User32.INSTANCE.FindWindowA(null, Native.toByteArray(propWindowName)); // window title
	       			if (hWnd!=null)
				...
				else
				{
					user32.EnumWindows(new User32.WNDENUMPROC() {
					 public boolean callback(Pointer hWnd, Pointer userData) {
		               ...
		               {
		            	    //System.out.println("Found matching window " + wText);
		            	    moveNativeWindowToTop(hWnd);
			                return false;
		               }
		               return true;
