...
/**
 * 
 * This plug-in manages the audio tracks present in the data/music folder and
 * different external request working as an interface with the wavefileplayer
 * plug-in
 * 
 * @author <David Ibanez Soria> [david.ibanez@starlab.es] Date: 30/08/2012 Time:
 *         16:22
 */
public class AudioSelectorInstance extends AbstractRuntimeComponentInstance {
    ...
    public AudioSelectorInstance() {
        /*
         * String track=" "; track= trackFilenames.get(0);
