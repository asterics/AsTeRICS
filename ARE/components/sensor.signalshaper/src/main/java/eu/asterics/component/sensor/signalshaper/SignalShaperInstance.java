 ...
 * 
 * @author Karol Pecyna [kpecyna@harpo.com.pl] Date: May 30, 2012 Time: 12:56:32
 *         AM
 */
public class SignalShaperInstance extends AbstractRuntimeComponentInstance {
    ...
    /*
     * double propBeginValue1 = 0; double propEndValue1 = 0; double propTime1 =
     * 0;
     */
     ...
     * 
     * @param time
     *            the time of current sample
     * @param line
     *            the current line
     * @param timeSteps
     *            the time steps of the lines
