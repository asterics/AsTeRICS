...
/**
 * JoystickCaptureInstance interfaces a standard joystick with up to 6 axis and
    ...
    public void start() {
        if (bridge.activate() != 0) {
            AstericsErrorHandling.instance.reportError(this,
                    "Could not find Joystick or Gamepad. Please verify that a Joystick or Gamepad is connected to a USB port !");
        }
        super.start();
    }
