...
public class OscServerInstance extends AbstractRuntimeComponentInstance {
    ...
    /**
     * This opens a server listening at port see Parameter. Recognized messages
     * are <code>/pause</code>, <code>/quit</code>, <code>/dumpOSC</code>. See
    ...
    public static void server(String protocol) {
        ...
        try {
            ...
            // AstericsErrorHandling.instance.reportInfo(OscServerInstance.instance,
        ...
        OscServerInstance.instance.c.addOSCListener(new OSCListener() {
            ...
            public void messageReceived(OSCMessage m, SocketAddress addr, long time) {
                ...
                // int i=0;
                // int occupiedports =
                // OscServerInstance.instance.propArgOfOscStream2 +
                // OscServerInstance.instance.propArgOfOscStream1+
                // OscServerInstance.instance.propArgOfOscStream3;
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH1)) {
                    ...
                    OscServerInstance.instance.opCH[1].sendData(
                            ConversionUtils.doubleToBytes((float) m.getArg(OscServerInstance.instance.propArgNrCH1)));
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH2)) {
                    ...
                    OscServerInstance.instance.opCH[2].sendData(
                            ConversionUtils.doubleToBytes((float) m.getArg(OscServerInstance.instance.propArgNrCH2)));
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH3)) {
                    ...
                    OscServerInstance.instance.opCH[3].sendData(
                            ConversionUtils.doubleToBytes((float) m.getArg(OscServerInstance.instance.propArgNrCH3)));
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH4)) {
                    ...
                    OscServerInstance.instance.opCH[4].sendData(
                            ConversionUtils.doubleToBytes((float) m.getArg(OscServerInstance.instance.propArgNrCH4)));
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH5)) {
                    ...
                    OscServerInstance.instance.opCH[5].sendData(
                            ConversionUtils.doubleToBytes((float) m.getArg(OscServerInstance.instance.propArgNrCH5)));

                    // OscServerInstance.instance.opCH[OscServerInstance.instance.propSetOutCH5].sendData(
                    // ConversionUtils.doubleToBytes((float)
                    // m.getArg(OscServerInstance.instance.propArgNrCH5)));

                }
                if (m.getName().equals(OscServerInstance.instance.propAddressCH6)) {

                    OscServerInstance.instance.opCH[6].sendData(
                            ConversionUtils.doubleToBytes((float) m.getArg(OscServerInstance.instance.propArgNrCH6)));
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH7)) {
                    ...
                    OscServerInstance.instance.opCH[7].sendData(
                            ConversionUtils.doubleToBytes((float) m.getArg(OscServerInstance.instance.propArgNrCH7)));
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH8)) {
                    ...
                    OscServerInstance.instance.opCH[8].sendData(
                            ConversionUtils.doubleToBytes((float) m.getArg(OscServerInstance.instance.propArgNrCH8)));
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH9)) {
                    ...
                    OscServerInstance.instance.opCH[9].sendData(
                            ConversionUtils.stringToBytes((String) m.getArg(OscServerInstance.instance.propArgNrCH9)));
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH10)) {
                    ...
                    OscServerInstance.instance.opCH[10].sendData(
                            ConversionUtils.stringToBytes((String) m.getArg(OscServerInstance.instance.propArgNrCH10)));
                ...
                if (m.getName().equals(OscServerInstance.instance.propAddressCH11)) {
                    ...
                    OscServerInstance.instance.opCH[11].sendData(
                            ConversionUtils.stringToBytes((String) m.getArg(OscServerInstance.instance.propArgNrCH11)));

                }
                if (m.getName().equals(OscServerInstance.instance.propAddressCH12)) {

                    OscServerInstance.instance.opCH[12].sendData(
                            ConversionUtils.stringToBytes((String) m.getArg(OscServerInstance.instance.propArgNrCH12)));
                }
