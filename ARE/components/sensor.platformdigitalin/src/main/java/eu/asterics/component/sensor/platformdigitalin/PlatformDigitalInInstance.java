...
/**
 * PlatformDigitalIn works with the inputs of the Core CIM (ID 0x0601). It
 ...
 *         Time: 02:22:08 PM
 */
public class PlatformDigitalInInstance extends AbstractRuntimeComponentInstance implements CIMEventHandler {
    ...
    public Object setRuntimePropertyValue(String propertyName, Object newValue) {
        try {
            if (KEY_PROPERTY_PERIODIC_UPDATE.equalsIgnoreCase(propertyName)) {
                ...
                AstericsErrorHandling.instance.reportInfo(this,
                        String.format("Setting input change event register to %x", propChangeEventRegister));
        ...
        if (((packet.getSerialNumber() & 0x80) != 0) && (packet.getFeatureAddress() == 0x1)) {
            ...
            for (int i = 0; i < NUMBER_OF_INPUTS; i++) {
                ...
                if (propPeriodicUpdate == 0) {
                    ...
                    if (is == 0) {
                        // System.out.println("PERIODIC RAISING LOW on port
                        // "+i);
                        // AstericsErrorHandling.instance.reportInfo(this,
                        // "Raising low trigger on " + i);
                        etpInLow[i].raiseEvent();
                        ...
                        // System.out.println("PERIODIC RAISING HIGH on port
                        // "+i);
                        // AstericsErrorHandling.instance.reportInfo(this,
                        // "Raising high trigger on " + i);
                        etpInHigh[i].raiseEvent();
