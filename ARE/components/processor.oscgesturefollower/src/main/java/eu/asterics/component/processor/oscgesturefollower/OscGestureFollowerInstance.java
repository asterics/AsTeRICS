 ...
 * 
 *  
 * @author Luka Samardzija [luka.samardzija@technikum-wien.at]
 *         Date: Sep 10,2012 
 *         Time: 09:44:55 AM
 */
public class OscGestureFollowerInstance extends AbstractRuntimeComponentInstance
{
    ...
    */
	...
	final IRuntimeEventListenerPort elpStoplearn = new IRuntimeEventListenerPort()
	{
		public void receiveEvent(final String data)
		{
			//AstericsErrorHandling.instance.reportInfo(OscGestureFollowerInstance.instance, "Stop_learn");
      ...
      */
      ...
      public static void client( String protocol )
		...
		try {
			...
			OscGestureFollowerInstance.instance.c.setTarget( new InetSocketAddress( InetAddress.getLocalHost(), OscGestureFollowerInstance.instance.propOutPort ));
//			OscGestureFollowerInstance.instance.c.setTarget( new InetSocketAddress( InetAddress.getLocalHost(), 9000 ));
			//postln( "  start()" );
			OscGestureFollowerInstance.instance.c.start();
		}
		catch( IOException e1 ) {
    ...
    @Override
  	public void syncedValuesReceived(HashMap<String, byte[]> dataRow) {
  		...
  		for (String s: dataRow.keySet())
  		{
  			...
  			//AstericsErrorHandling.instance.reportInfo(OscClientInstance.instance, "syncronized");		
