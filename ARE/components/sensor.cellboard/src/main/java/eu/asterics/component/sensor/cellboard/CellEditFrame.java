...
/**
 * @author Chris Veigl This class generates a JFrame for setting the Cell
 *         properties
 * 
 *         Date: Jan 11, 2015
 */
public class CellEditFrame extends JDialog {
    ...
    // The current directory of the running ARE. This assumes that the ARE is
    // started from within the location of the start file.
    ...
    public CellEditFrame(final GUICell parent) {
        ...
        setPreferredSize(new Dimension(CELLEDIT_FRAME_WIDTH, CELLEDIT_FRAME_HEIGHT));
        // setLocation(100,100);
        ...
        openSoundPreviewButton.addActionListener(new ActionListener() {
            // openSoundPreviewButton.setPreferredSize(new Dimension(25,
            // FIELDHEIGHT));
            @Override
            public void actionPerformed(ActionEvent arg0) {
        ...
        openSwitchGridButton.addActionListener(new ActionListener() {
            // openSwitchGridButton.setPreferredSize(new Dimension(25,
            // FIELDHEIGHT));
            @Override
            public void actionPerformed(ActionEvent arg0) {
        ...
        if (instance.propKeyboardFile != "") {
            if ((instance.propKeyboardFile.startsWith(instance.FILE_PATH_PREFIX))
                    || (instance.propKeyboardFile.startsWith(instance.FILE_PATH_PREFIX2))) {
                fileNameField.setText(instance.propKeyboardFile);
            } else {
                fileNameField.setText(instance.FILE_PATH_PREFIX + instance.propKeyboardFile);
            }
        } else {
            fileNameField.setText(instance.FILE_PATH_PREFIX + "dummy.xml");
        }
        ...
        savebutton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (fileNameField.getText().length() > 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "Please enter a filename to save the keyboard .xml file !",
    ...
    String fileChooser(String directory) {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            if (extension != null) {
                 ...
                 * "The selected file is valid.", "Invalid file",
