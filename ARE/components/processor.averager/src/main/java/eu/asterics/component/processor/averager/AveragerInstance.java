...
/**
 *   Implements the Averager plugin, which outputs the average value
 *   of the most recent n samples of an input signal
 *  
 * 
...
//                    }
    ...
    /**
     * processes the averager function according to selected mode
     * MODE_AVERAGE: the samples are summed and divided by buffer the size
