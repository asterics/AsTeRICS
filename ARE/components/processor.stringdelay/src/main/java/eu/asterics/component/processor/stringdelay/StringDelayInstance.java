...
import eu.asterics.component.processor.stringdelay.DelayTimer;
 ...
 *         Time: 
 */
public class StringDelayInstance extends AbstractRuntimeComponentInstance
{
	...
	private class DelayItem
	{
		...
		DelayItem (long time, String value)
		{
			this.time=time;
			this.value=value;
		}
    ...
    */
	...
	long sendEvent()
	{
		...
		try
		{
			...
			{
				opOut.sendData(ConversionUtils.stringToBytes(eventTime.firstElement().value));
				eventTime.remove(0);
