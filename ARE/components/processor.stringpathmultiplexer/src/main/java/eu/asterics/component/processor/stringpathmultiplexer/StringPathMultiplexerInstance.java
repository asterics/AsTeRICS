...
package eu.asterics.component.processor.stringpathmultiplexer;
 ...
 *         AM
 */
public class StringPathMultiplexerInstance extends AbstractRuntimeComponentInstance {
     ...
     */
    public StringPathMultiplexerInstance() {
    }
    ...
    private final IRuntimeInputPort ipInput1 = new DefaultRuntimeInputPort() {
        ...
        public void receiveData(byte[] data) {
            ...
            if (selected_port == 1) {
                outputPort.sendData(ConversionUtils.stringToBytes(in));
            }
        }
