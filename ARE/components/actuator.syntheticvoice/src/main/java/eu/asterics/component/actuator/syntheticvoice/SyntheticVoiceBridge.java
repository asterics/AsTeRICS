...
import eu.asterics.component.actuator.syntheticvoice.SyntheticVoiceInstance;
...
/**
 * Interfaces the native SyntheticVoiceBridge.dll library for the Synthetic Voice plugin
 * 
...
public class SyntheticVoiceBridge
{
   ...
   * @param componentInstance object of the SyntheticVoiceInstance class.
   */  
   ...
   * @param xmlTags support for XML tags.
   */  
  ...
  public void start()
  {
    ...
    if(result<0)
    {
      ...
      {
        AstericsErrorHandling.instance.getLogger().warning("Synthetic Voice: user voice not found, the default voice will be used");
    	active=true;
      }
   ...
   * @param speed speed of the voice
   * @param voice voice name
   * @param xmlTags support for the XML tags 
