...
/**
 * Implements the timer plugin, which uses a thread to measure time and triggers
 * events when time period has passed. The timer can be configured for periodic
 * of one-shot operation.
 * 
