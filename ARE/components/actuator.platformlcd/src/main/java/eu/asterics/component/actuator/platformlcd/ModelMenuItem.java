...
/**
 * ModelMenuItem represents all menu entries which will load a stored model from
 * the ARE's model storage. Pressing ok on an instance of this class will cause
 * the ARE to stop the current model and deploy and start the new one.
 * 
...
public class ModelMenuItem extends ActionMenuItem {
     ...
     * 
     * @param caption
     *            the text to be displayed (usually the name of the model)
     * @param owner
     *            the owning display instance
     */
