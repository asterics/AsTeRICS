...
/**
 * 
 * Find skeleton with Kinect v1 (SDK for Windows) and return Joint-Points with 3 Dimensions (X,Y,Z)
 * 
 * 
 *  
    ...
    */
    ...
    public Object setRuntimePropertyValue(String propertyName, Object newValue)
    {
      ...
      */
      ...
      public void setJointPointsAnkle(double AnkleLeftX, double AnkleLeftY, double AnkleLeftZ, double AnkleRightX, double AnkleRightY, double AnkleRightZ)
      {
      ...
      public void setJointPointsKnee(double KneeLeftX, double KneeLeftY, double KneeLeftZ, double KneeRightX, double KneeRightY, double KneeRightZ)
      {
      ...
      public void setJointPointHip(double HipLeftX, double HipLeftY, double HipLeftZ, double HipCenterX, double HipCenterY, double HipCenterZ , double HipRightX, double HipRightY, double HipRightZ)
      {
      ...
      public void setJointPointShoulder (double ShoulderLeftX, double ShoulderLeftY, double ShoulderLeftZ, double ShoulderCenterX, double ShoulderCenterY, double ShoulderCenterZ, double ShoulderRightX, double ShoulderRightY , double ShoulderRightZ)
      {
      ...
      public void setJointPointElbow(double ElbowLeftX, double ElbowLeftY, double ElbowLeftZ, double ElbowRightX, double ElbowRightY, double ElbowRightZ)
      {
      ...
      public void setJointPointWrist(double WristLeftX, double WristLeftY, double WristLeftZ , double WristRightX, double WristRightY, double WristRightZ)
      {
      ...
      public void setJointPointHand (double HandLeftX, double HandLeftY, double HandLeftZ, double HandRightX, double HandRightY , double HandRightZ)
      {
