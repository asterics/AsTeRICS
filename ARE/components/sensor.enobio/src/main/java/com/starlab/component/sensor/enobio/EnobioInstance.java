 ...
 *         02:29:56 PM
 */
public class EnobioInstance extends AbstractRuntimeComponentInstance implements
		IEnobio {
	...
	public Object setRuntimePropertyValue(String propertyName, Object newValue) {
		...
		if ("HighPassFilterInChannel1".equalsIgnoreCase(propertyName)) {
			...
			if (newValue != null) {
				propHighPassFilterInChannel1 = Boolean.parseBoolean((newValue
						.toString()));
			...
			if (newValue != null) {
				propHighPassFilterInChannel2 = Boolean.parseBoolean((newValue
						.toString()));
			...
			if (newValue != null) {
				propHighPassFilterInChannel3 = Boolean.parseBoolean((newValue
						.toString()));
			...
			if (newValue != null) {
				propHighPassFilterInChannel4 = Boolean.parseBoolean((newValue
						.toString()));
			...
			if (newValue != null) {
				propIsChannel1Activated = Boolean.parseBoolean((newValue
						.toString()));
			...
			if (newValue != null) {
				propIsChannel2Activated = Boolean.parseBoolean((newValue
						.toString()));
			...
			if (newValue != null) {
				propIsChannel3Activated = Boolean.parseBoolean((newValue
						.toString()));
			...
			if (newValue != null) {
				propIsChannel4Activated = Boolean.parseBoolean((newValue
						.toString()));
			...
			if (newValue != null) {
				propLineNoiseFilter = Boolean
						.parseBoolean((newValue.toString()));
	...
	public void newValues(int v1, int v2, int v3, int v4, int vStatus) {
		int externalSignalValue = ((vStatus & 0x00ff0000) > 0) ? 1 : 0; // Bit of vStatus carries the external signal level
