...
/**
 * 
 * This plugin interfaces the Intel Real Sense 3D cameras and provide head tracking data and triggers events in case of
 * facial expressions.
 * 
 * 
 *  
 * @author Christoph Acker [acker_christoph@yahoo.de]
 *         Date: 30/06/2016 
 */
      ...
      public void start()
      {
    	  ...
    	  AstericsThreadPool.instance.execute(new Callable() {
			...
			public Object call() throws Exception {
				...
				AstericsErrorHandling.instance.getLogger().fine("Intel Real Sense camera initialized, starting tracking");
