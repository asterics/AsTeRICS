...
/**
 * 
 * This plugin can be used to operate a GMail Webclient. It provides several
 * shortcut emulations that can be triggered by input port commands.
 * 
 * 
 * 
 * @author Fabien Kolinsky [fkolinsky@gmx.at] Date: 30/06/2016
 */
