...
#include <jni.h>
/* Header for class eu_asterics_component_sensor_trackir_jni_Bridge */

#ifndef _Included_eu_asterics_component_sensor_trackir_jni_Bridge
#define _Included_eu_asterics_component_sensor_trackir_jni_Bridge
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     eu_asterics_component_sensor_trackir_jni_Bridge
 * Method:    activate
 * Signature: ()I
 */
