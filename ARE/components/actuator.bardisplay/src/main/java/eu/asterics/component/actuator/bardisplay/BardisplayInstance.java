...
/**
 * 
 * Implements the Bardisplay actuator plugin, which can show values on the ARE
 * GUI in a simple meter display with adjustable size and color
 * 
