...
/**
 * 
 * This module implements the SSVEP training and is in charge of running the
 * training protocol defined by the user within its properties consisting of N
 * stimulation trials at the frequencies defined.
 * 
 * @author David Ibanez [david.ibanez@starlab.es] Date: 30/08/2012 Time: 15:00
 */
