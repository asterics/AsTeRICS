...
/**
 * AnalogOutInstance communicates with the DAC outputs of the ADC-DAC CIM of the
 * AsTeRICS platform. It provides a very simplistic interface which only
 * translates the digital input to the component to analog values on outputs of
...
public class AnalogOutInstance extends AbstractRuntimeComponentInstance {
    ...
    public void start() {
        ...
        if (port != null) {
            ...
            AstericsErrorHandling.instance.reportError(this,
                    String.format(
                            "Could not find AnalogOut CIM (0x%x) in PortManager. Please verify that the CIM Module is connected to an USB Port and that the driver is installed.",
                            ADC_CIM_ID));
        }
    }
     ...
     * 
     * @param value
     *            the voltage value (0 to 240 representing 100mV steps)
     * @param index
     *            the index of the output to set the value on
     */
