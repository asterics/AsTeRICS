...
/**
 * 
 * This plugin allows to play a stereo tone with a specified frequency. The
 * frequency of the left and right channel can be set separately
 * 
 * 
 * @author David Thaller [dt@ki-i.at] Date: 10.09.2013 Time:
 */
