...
/**
 * 
 * WiiMoteInstance interfaces to a WiiMote controller and possibly a Nunchuck
 * Extesion via JNI and the WiiYourself! Library. Provided sensor information
 * includes: Wiimote pitch and roll, up/down/left/A/B/+/-/1/2/Home button
 * events, Nunchuck Joystick x/Y position and Battery Level.
 * 
 * 
