...
/**
 *   Implements the pathselector plugin, which selects routes the input
...
public class PathselectorInstance extends AbstractRuntimeComponentInstance
{
	...
	private final IRuntimeInputPort ipIn	= new DefaultRuntimeInputPort()
	{
		public void receiveData(byte[] data)
		{
			...
			switch (selectedPort) {
			case 1: opOut1.sendData(ConversionUtils.doubleToBytes(in));
			break;
			case 2: opOut2.sendData(ConversionUtils.doubleToBytes(in));
			break;
			case 3: opOut3.sendData(ConversionUtils.doubleToBytes(in));
			break;
			case 4: opOut4.sendData(ConversionUtils.doubleToBytes(in));
			break;
			default: break;
			}
		}
