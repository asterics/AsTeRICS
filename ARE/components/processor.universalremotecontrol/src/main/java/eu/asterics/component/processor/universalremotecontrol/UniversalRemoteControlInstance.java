 ...
 * 
 * 
 * @author Christoph Ulbinger [christoph.ulbinger@technikum-wien.at] Date:
 *         08.04.2015 Time: 09:41
 */
public class UniversalRemoteControlInstance extends AbstractRuntimeComponentInstance implements CIMEventHandler {
    ...
    final IRuntimeEventListenerPort elpSendIRCode = new IRuntimeEventListenerPort() {
        ...
        public void receiveEvent(final String data) {
            ...
            if ((DeviceType != "") && (DeviceName != "") && (DeviceFunction != "")) {
                ...
                if (port != null) {
                    CIMPortManager.getInstance().sendPacket(port, IRCode, UIRC_CIM_FEATURE_SET_IR_CODE,
    ...
    public void start() {
        ...
        if (port != null) {
            ...
            AstericsErrorHandling.instance.reportError(this,
                    "Could not find UIRC Module. Please verify that the Module is connected to an USB Port and that the driver is installed.");
        }
