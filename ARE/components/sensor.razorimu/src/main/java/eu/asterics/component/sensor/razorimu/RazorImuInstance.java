 ...
 * 
 * @author Christoph Weiss [weissch@technikum-wien.at] Date: Nov 29, 2010 Time:
 *         10:22:08 AM
 */
public class RazorImuInstance extends AbstractRuntimeComponentInstance implements CIMEventHandler {
    ...
    void parsePacket() {
        ...
        try {
            ...
            if (inputQueue.removeFirst() == 'A' && inputQueue.removeFirst() == 'N' && inputQueue.removeFirst() == 'G'
            ...
            Logger.getAnonymousLogger()
                    .fine("Read values: pitch " + values[0] + ",yaw: " + values[1] + ",roll: " + values[2]);
    ...
    public void handlePacketReceived(CIMEvent ev) {
        ...
        case PitchYawRoll:
            ...
            if (data == '\n') {
                // Logger.getAnonymousLogger().info("Packet end detected,
                // parsing ...");
                parsePacket();
            }
            break;
