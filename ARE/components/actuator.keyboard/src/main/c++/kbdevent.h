...
#include <jni.h>
/* Header for class eu_asterics_component_actuator_keyboard_KeyboardInstance */

#ifndef _Included_eu_asterics_component_actuator_keyboard_KeyboardInstance
#define _Included_eu_asterics_component_actuator_keyboard_KeyboardInstance
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     eu_asterics_component_actuator_keyboard_KeyboardInstance
 * Method:    keypress
 * Signature: (I)I
 */
