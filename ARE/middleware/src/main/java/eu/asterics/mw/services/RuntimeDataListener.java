...
/**
 * This abstract class should be implemented by anyone that desires to receive
 * runtime data of the active AsTeRICS model.
 * 
...
public abstract class RuntimeDataListener {
     ...
     * 
     * @param componentId
     *            - the component that hold the changed property
     * @param componentKey
    ...
    /**
     * This method will be triggered when an event is transmitted through an
     * {@link IEventChannel}.
     * 
     * @param channelId
     *            - the id of the eventChannel
    ...
    /**
     * This method will be triggered when data are transmitted through an
     * {@link IChannel}. Due to the fact that data channels could transmit a
     * significant amount of data, a listener is able to choose what specific
     * channels will be monitoring with the use of
     ...
     * 
     * @return - a set of {@link IChannel} that is currenty monitored for this
     *         listener
     */
     ...
     * 
     * @param dataChannelIds
     *            - the set of {@link IChannel} to monitor
     */
     ...
     * 
     * @param dataChannelId
     *            - the {@link IChannel} id to be added to the {@link IChannel}
     *            that are monitored
     */
     ...
     * 
     * @param dataChannelId
     *            - the if of the {@link IChannel} that will not be monitored
     * @return
     */
