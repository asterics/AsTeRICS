...
public interface IAREServices {
     ...
     * 
     * @param panel
     *            all the internal elements of these JPanels will have their
     *            fonts auto-adjusted
     * @param maxFontSize
     *            in cases where there is too much space the font size will be
     *            restricted to this upper bound
     * @param minFontSize
     *            in case there is too little space the text might not be
     *            readable, the font size can be restricted to this minimum.
     * 
     * @param offset
     *            The font size in relation to the dimensions of the
     *            <code>panel</code> and the size of the text. The offset is
     *            used in case you do not want to occupy the whole
     *            <code>panel</code> width.
     */
