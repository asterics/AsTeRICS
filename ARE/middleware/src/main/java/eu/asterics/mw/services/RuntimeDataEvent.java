...
public class RuntimeDataEvent {
    ...
    /**
     * Creates a RuntimeDataEvent with type
     * {@link RuntimeDataEvent#TYPE_EVENT_CHANNEL}
     * 
     * @param channelId
    ...
    /**
     * Creates a RuntimeDataEvent with type
     * {@link RuntimeDataEvent#TYPE_DATA_CHANNEL}
     * 
     * @param channelId
     *            - the id of the channel
     * @param data
     *            - the actual data of the channel
     */
    ...
    /**
     * Creates a RuntimeDataEvent with type
     * {@link RuntimeDataEvent#TYPE_COMPONENT_PROPERTY_CHANGE}
     * 
     * @param componentId
     *            - the id of the modified component
     * @param componentKey
     *            - the key of the modified property of the component
     * @param data
     *            - the new value of the property
     * 
     * @return - the {@link RuntimeDataEvent} object initialized with the given
     *         parameters
     */
