...
public class DefaultRuntimeModel implements IRuntimeModel {
    ...
    public DefaultRuntimeModel(final String modelName, final ModelDescription modelDescription,
            final Set<IChannel> channels, final Set<IEventChannel> eventChannels,
            final Set<IComponentInstance> components, final String modelVersion, ArrayList<DefaultACSGroup> groups,
    ...
    public void removeComponentInstance(String componentID) throws AREAsapiException {
        ...
        Iterator<IComponentInstance> itr = components.iterator();
        ...
        logger.severe(this.getClass().getName() + "Couldn't find component " + "instance with ID:" + componentID);

        throw new AREAsapiException("Couldn't find component instance with ID:" + componentID);
    }
    ...
    public void removeChannel(String channelID) throws AREAsapiException {
        IChannel ch = null;
        Iterator<IChannel> itr = channels.iterator();
        ...
        logger.severe(this.getClass().getName() + "Couldn't find component " + "instance with ID:" + channelID);
        throw new AREAsapiException("Couldn't find component instance with ID:" + channelID);
    }
