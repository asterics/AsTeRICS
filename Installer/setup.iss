...
Filename: {tmp}\dotNetFx40_setup.exe; Parameters: "/q:a /c:""install /l /q"""; Check: CheckForFramework; StatusMsg: Microsoft Framework 4.0 is be�ng installed. Please wait...
Filename: {tmp}\vcredist_x86.exe; Parameters: "/q:a /c:""install /l /q"""; Check: VCSetupNeeded; StatusMsg: Microsoft Visual C++ 2010 is be�ng installed. Please wait...
